...
Alacritty is awesome and there are a lot of contributors that makes this app
much more. I basically added 2 features on top of alacritty:
...
3. [Alacritty bg](https://codeberg.org/HanY/alacritty-bg/commits/branch/master)
    (with added background-video support)

   (( to build in cargo currently, use `RUSTFLAGS="$RUSTFLAGS -A dead_code" cargo build` ))
